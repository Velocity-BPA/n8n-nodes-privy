...
/**
 * Sign Transaction operation properties
 */
export const signTransactionProperties: INodeProperties[] = [
	...
	},
	{
		...
		default: 'ethereum',
		description: 'The chain to sign the transaction for',
		displayOptions: {
			show: {
				resource: ['serverWallet'],
				operation: ['signTransaction'],
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'number',
				default: undefined,
				description: 'Transaction nonce (auto if not specified)',
			},
		],
	},
];
...
/**
 * Execute sign transaction operation
 */
export async function execute(
	...
	if (gasOptions.nonce !== undefined) {
		transaction.nonce = gasOptions.nonce;
	}
